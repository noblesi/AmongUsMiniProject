...
public class EngineBody : MonoBehaviour
{
    ...
    [SerializeField] private List<GameObject> steams = new List<GameObject>();
    [SerializeField] private List<SpriteRenderer> sparks = new List<SpriteRenderer>();
    [SerializeField] private List<Sprite> sparkSprites = new List<Sprite>();
